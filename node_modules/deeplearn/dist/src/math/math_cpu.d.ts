...
export declare class NDArrayMathCPU extends NDArrayMath {
    ...
    protected stepInternal<T extends NDArray>(ndarray: T, alpha?: number): T;
    ...
    protected depthwiseConv2DInternal(input: Array4D, filter: Array4D, convInfo: DepthwiseConvInfo): Array4D;
    ...
    protected batchNormalization2DInternal(x: Array2D, mean: Array2D | Array1D, variance: Array2D | Array1D, varianceEpsilon: number, scale?: Array2D | Array1D, offset?: Array2D | Array1D): Array2D;
