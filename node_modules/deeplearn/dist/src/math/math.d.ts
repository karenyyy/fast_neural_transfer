...
export declare abstract class NDArrayMath {
    ...
    protected abstract stepInternal<T extends NDArray>(ndarray: T, alpha: number): T;
    ...
    depthwiseConv2D(input: Array3D | Array4D, filter: Array4D, strides: [number, number] | number, pad: 'valid' | 'same' | number, rates?: [number, number] | number): Array3D | Array4D;
    protected abstract depthwiseConv2DInternal(input: Array4D, filter: Array4D, convInfo: DepthwiseConvInfo): Array4D;
    ...
    protected abstract batchNormalization2DInternal(x: Array2D, mean: Array2D | Array1D, variance: Array2D | Array1D, varianceEpsilon: number, scale?: Array2D | Array1D, offset?: Array2D | Array1D): Array2D;
